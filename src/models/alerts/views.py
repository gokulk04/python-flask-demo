...
def index():
    return "Alerts index page"

@alert_blueprint.route("/create", methods=['POST', 'GET'])
@user_decorators.requires_login     # redirect user to user.login if session[email'] is None
def create_alert():
